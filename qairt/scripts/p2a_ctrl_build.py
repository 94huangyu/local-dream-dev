...
OVR = os.path.join(W, "part2a_ctrl_overrides.json")
...
f = os.path.join(W, "part2a_ctrl_fp32.dlc")
q = os.path.join(W, "part2a_ctrl_quantized.dlc")
...
run("01_conv_p2a_ctrl", cmd, 7200)
run("02_quant_p2a_ctrl",
